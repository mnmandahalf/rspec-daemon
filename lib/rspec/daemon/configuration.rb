  ...
  class Daemon
    class Configuration
      ...
      def record_configuration(&configuration_block)
        ...
        self.root_shared_examples = ::RSpec.world.shared_example_group_registry.shared_example_groups.dup
      ...
      def replay_configuration
        ...
        RSpec.world.shared_example_group_registry.shared_example_groups.replace(self.root_shared_examples)
